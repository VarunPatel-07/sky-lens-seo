import { HomepageCheck, HomepageCheckAccent } from "./page.interface";
...
export const HOMEPAGE_CHECKS_EYEBROW = "The audit";
...
export const HOMEPAGE_CHECK_ACCENT_CLASSES: Record<HomepageCheckAccent, string> = {
  primary: "bg-primary/10 text-primary",
  teal: "bg-teal/10 text-teal",
  amber: "bg-amber-soft text-amber-text",
};

export const HOMEPAGE_STEPS_EYEBROW = "The process";
