...
import {
  SKYPHR_CARD_RADIUS,
  SKYPHR_HOMEPAGE_LABEL,
  SKYPHR_SECTION_PADDING,
} from "@/constants/skyphrBrand.constant";
    ...
    >
      ...
      >
        ...
        >
          ...
          <SkyphrCtaButton href={SKYPHR_HOMEPAGE_URL} label={ABOUT_SKYPHR_LINK_LABEL} external />
        </motion.div>
      </motion.div>
    </main>
  );
